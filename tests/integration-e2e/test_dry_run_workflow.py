...
def test_dry_run_workflow(USECASE3):
    ...
    rank_allocation, _, cell_memory_usage = nd._dry_run_stats.distribute_cells(2, 1, 1, 1)
    ...
    rank_allocation, _, cell_memory_usage = nd._dry_run_stats.distribute_cells(1, 1, 1, 1)
    export_allocation_stats(rank_allocation,
